...
function Home() {
    ...
    const londonCurrentWeatherVar = <LondonCurrentWeatherComp londonCurrentWeather={londonCurrentWeather} />;
    const losAngelesCurrentWeatherVar = <LosAngelesCurrentWeatherComp losAngelesCurrentWeather={losAngelesCurrentWeather} />;
    ...
    return (
        <div className={styles.Home}>
            ...
            <button className={styles["toggle-btn"]} onClick={goToLondon16DaysWeather}>
                <strong>London </strong><>
                    {londonCurrentWeatherVar}
                </>
            </button>

            <button className={styles["toggle-btn"]} onClick={goToLosAngeles16DaysWeather}>
            ...
            <Routes>
                ...
                />
                <Route
                    path="/London16DaysWeather"
                    element={<London16DaysWeather />}
                />
                <Route
